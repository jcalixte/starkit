...
**Cascade:** [I Needs × Functions](./house-1-needs-functions.md) → **II Functions × Components** → [III Components × Operations](./house-3-components-operations.md) → [IV Operations × Controls](./house-4-operations-controls.md) · [all four in DESIGN.md](../../DESIGN.md#houses-of-quality)
...
[House I](./house-1-needs-functions.md)'s relative weight, so component priority is derived here
...
weight says where the needs actually land. What no column here shows is whether anything *checks* a
component — that is [House III](./house-3-components-operations.md), and C1 and C6 come out of it
with an almost empty row.

---

**Carried from [House I](./house-1-needs-functions.md), carries into
